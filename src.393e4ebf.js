...
} // ASSET: components/EventLogger.js


// ASSET: ../node_modules/react/cjs/react.development.js
var $20$exports = {};
...
var $15$var$_createClass = function () {
...
function $15$var$_classCallCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot call a class as a function");
  }
}

function $15$var$_possibleConstructorReturn(self, call) {
  if (!self) {
...
function $15$var$_inherits(subClass, superClass) {
...
var $20$interop$default = $parcel$interopDefault($20$exports);

var $15$export$default = function (_React$Component) {
  $15$var$_inherits($15$export$default, _React$Component);

  function $15$export$default() {
    $15$var$_classCallCheck(this, $15$export$default);
    return $15$var$_possibleConstructorReturn(this, ($15$export$default.__proto__ || Object.getPrototypeOf($15$export$default)).apply(this, arguments));
  }

  $15$var$_createClass($15$export$default, [{
    key: "render",
    value: function render() {
      ...
      }, React.createElement("caption", null, React.createElement("ul", null, React.createElement("li", null, this.renderBoolean(true), " = true"), React.createElement("li", null, this.renderBoolean(false), " = false"), React.createElement("li", null, this.renderBoolean(undefined), " = null or undefined"), React.createElement("li", null, React.createElement("sup", null, "1"), " refers to properties present in both KeyboardEvent and InputEvent."), React.createElement("li", null, React.createElement("button", {
        onClick: this.props.insertSeparator
      }, "Insert separator \u2195")), React.createElement("li", null, React.createElement("button", {
        onClick: this.props.clearLog
      }, "Clear log \u267A")), React.createElement("li", {
        className: "react-ver"
      }, "React ", $20$interop$default.d.version))), React.createElement("thead", null, React.createElement("tr", null, React.createElement("th", {
        colSpan: "3"
      }, "General"), React.createElement("th", {
        colSpan: "3"
      }, "KeyboardEvent"), React.createElement("th", null, "UIEvent", React.createElement("sup", null, "1")), React.createElement("th", {
        colSpan: "2"
      }, "InputEvent")), React.createElement("tr", null, React.createElement("th", null, "#"), React.createElement("th", null, "constructor"), React.createElement("th", null, "type"), React.createElement("th", null, "key"), React.createElement("th", null, "code"), React.createElement("th", null, "repeat"), React.createElement("th", null, "isComposing"), React.createElement("th", null, "inputType"), React.createElement("th", null, "data"))), React.createElement("tbody", null, logs.map(function (entry) {
        return React.createElement("tr", {
          key: entry.index,
          className: 'logger__row logger__row--' + entry.kind + (entry.isNativeCounterpart ? ' logger__row--native-counterpart' : '')
        }, React.createElement("td", null, entry.isNativeCounterpart ? '⮑' : entry.index), React.createElement("td", null, _this2.renderKind(entry.kind, entry.origin)), React.createElement("td", null, _this2.renderValue(entry.type)), React.createElement("td", null, _this2.renderValue(entry.key)), React.createElement("td", null, _this2.renderValue(entry.code)), React.createElement("td", null, _this2.renderBoolean(entry.repeat)), React.createElement("td", null, _this2.renderBoolean(entry.isComposing)), React.createElement("td", null, _this2.renderValue(entry.inputType)), React.createElement("td", null, _this2.renderValue(entry.data)));
      })));
    }
  }, {
    key: "renderValue",
    value: function renderValue(val) {
      return val ? React.createElement("pre", null, React.createElement("code", null, val)) : this.renderBoolean(undefined);
    }
  }, {
    key: "renderBoolean",
    value: function renderBoolean(flag) {
      return flag === true ? React.createElement("span", {
        className: "bool bool--true",
        title: "true"
      }, "\u2713") : flag === false ? React.createElement("span", {
    ...
    value: function renderKind(kind, origin) {
      return kind ? React.createElement("pre", null, React.createElement("code", null, kind, " ", origin ? React.createElement("span", {
        className: "origin"
      }, origin) : null)) : this.renderBoolean(undefined);
    }
  }]);
  return $15$export$default;
}($20$interop$default.d.Component); // ASSET: components/EventListenerRaw.js
// ASSET: index.js


function $16$var$_classCallCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot call a class as a function");
  }
}

var $16$var$supported_events = [// KeyboardEvent
'keydown', 'keypress', 'keyup', // CompositionEvent
'compositionstart', 'compositionupdate', 'compositionend', // InputEvent
'beforeinput', 'input', // Selection Event
'selectionchange'];

var $16$export$default = function EventListenerRaw(container, onevent) {
  var _this = this;

  $16$var$_classCallCheck(this, EventListenerRaw);
  this.container = container;

  this.onevent = onevent || function () {};

  $16$var$supported_events.forEach(function (eventStr) {
    return _this.container.addEventListener(eventStr, _this.onevent);
  });
}; // ASSET: components/EventListenerReact.js


var $17$var$_createClass = function () {
  function defineProperties(target, props) {
    for (var i = 0; i < props.length; i++) {
      var descriptor = props[i];
      descriptor.enumerable = descriptor.enumerable || false;
...
function $17$var$_classCallCheck(instance, Constructor) {
  if (!(instance instanceof Constructor)) {
    throw new TypeError("Cannot call a class as a function");
  }
}

function $17$var$_possibleConstructorReturn(self, call) {
  if (!self) {
    throw new ReferenceError("this hasn't been initialised - super() hasn't been called");
  }
...
function $17$var$_inherits(subClass, superClass) {
  if (typeof superClass !== "function" && superClass !== null) {
    throw new TypeError("Super expression must either be null or a function, not " + typeof superClass);
  }
...
var $17$export$default = function (_React$Component) {
  $17$var$_inherits($17$export$default, _React$Component);

  function $17$export$default() {
    $17$var$_classCallCheck(this, $17$export$default);
    return $17$var$_possibleConstructorReturn(this, ($17$export$default.__proto__ || Object.getPrototypeOf($17$export$default)).apply(this, arguments));
  }

  $17$var$_createClass($17$export$default, [{
    key: "render",
    value: function render() {
  ...
  return $17$export$default;
}($20$interop$default.d.Component); // ASSET: utils/serialize-event.js
// ASSET: utils/generate-key.js


var $19$var$key = 1;

var $19$export$getKey = function $19$export$getKey() {
  return $19$var$key;
};

var $19$export$getNextKey = function $19$export$getNextKey() {
  return $19$var$key++;
};

var $19$export$resetKey = function $19$export$resetKey() {
  return $19$var$key = 1;
};

var $18$export$default = function (e, callbackName, isNativeCounterpart) {
  var index = isNativeCounterpart ? '\u2B91 ' + $19$export$getKey() : $19$export$getNextKey();
  var ret = {
  ...
  'key', 'code', 'repeat', // Common to KeyboardEvent and InputEvent
  'isComposing', // InputEvent
...
// ASSET: ../node_modules/react-dom/cjs/react-dom.development.js
var $21$exports = {};
...
if ('production' !== "production") {
  (function () {
...

    {
      ...
      if (isProxySupported) {
        /*eslint-disable no-func-assign */SyntheticEvent = new Proxy(SyntheticEvent, {
    ...
    var POSITIVE_NUMERIC = 6; /* eslint-disable max-len */
    ...
    var DidCapture = /*            */64;
    var Ref = /*                   */128;
    var Snapshot = /*              */256; // Union of all host effects
    ...
    function getOffsets(outerNode) {
      ...
      try {
        ...
        focusNode.nodeType; /* eslint-enable no-unused-expressions */
      } catch (e) {
        return null;
      }
...
// ASSET: ../node_modules/immutable/dist/immutable.js
var $22$exports = {};
var $22$var$global = arguments[0];
var $22$var$define; /**
...
(function (global, factory) {
  typeof $22$exports === 'object' && 'object' !== 'undefined' ? $22$exports = factory() : typeof $22$var$define === 'function' && $22$var$define.amd ? $22$var$define(factory) : global.Immutable = factory();
})($22$exports, function () {
...
var $7$var$logs = new $22$exports.Stack();
var $7$var$STACK_LIMIT = 100;

var $7$var$add_log = function $7$var$add_log(item) {
  $7$var$logs = $7$var$logs.push(item).slice(0, $7$var$STACK_LIMIT);
};

var $7$var$log_event = function $7$var$log_event(e, callbackName) {
  if (e.nativeEvent) {
    $7$var$add_log($18$export$default(e.nativeEvent, null, true));
  }

  $7$var$add_log($18$export$default(e, callbackName));
  $7$var$render_logs();
};

var $7$var$clear_log = function $7$var$clear_log() {
  $7$var$logs = new $22$exports.Stack();
  $19$export$resetKey();
  $7$var$render_logs();
};

var $7$var$insert_separator = function $7$var$insert_separator() {
  $7$var$add_log({
    index: $19$export$getNextKey(),
    kind: 'separator'
  });
  $7$var$render_logs();
};

var $7$var$logger_el = document.querySelector('.logger');

var $7$var$render_logs = function $7$var$render_logs() {
  var $21$interop$default = $parcel$interopDefault($21$exports);
  $21$interop$default.d.render(React.createElement($15$export$default, {
    logs: $7$var$logs,
    clearLog: $7$var$clear_log,
    insertSeparator: $7$var$insert_separator
  }), $7$var$logger_el);
};

var $21$interop$default = $parcel$interopDefault($21$exports);
$21$interop$default.d.render(React.createElement($17$export$default, {
  onevent: $7$var$log_event
}), document.querySelector('#rte__wrapper--react'));
new $16$export$default(document.querySelector('#rte--raw'), $7$var$log_event);
return {
  7: {}
};
});